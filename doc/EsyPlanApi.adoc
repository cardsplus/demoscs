...
hide members
show attributes
class NutzerValue<JsonJpaValueBase> {
}
package "plan" {
  ...
  ProjektValue "1" *-- "*" AufgabeValue
  ProjektValue "1" --> "1" NutzerValue : besitzer
  ProjektValue "1" --> "*" NutzerValue : mitglied
}
----
...
include::{projectDir}/app/backend/src/main/java/esy/app/plan/ProjektRestApi.adoc[leveloffset=+1]

include::{projectDir}/app/backend/src/main/java/esy/app/plan/AufgabeRestApi.adoc[leveloffset=+1]
