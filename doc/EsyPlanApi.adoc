...
include::../app/backend-data/src/main/java/esy/app/plan/ProjektRestApi.adoc[leveloffset=+1]

include::../app/backend-data/src/main/java/esy/app/plan/AufgabeRestApi.adoc[leveloffset=+1]
