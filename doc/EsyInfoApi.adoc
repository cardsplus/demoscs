...
include::../app/backend-data/src/main/java/esy/app/info/HealthRestApi.adoc[leveloffset=+1]

include::../app/backend-data/src/main/java/esy/app/info/VersionRestApi.adoc[leveloffset=+1]

include::../app/backend-data/src/main/java/esy/app/info/EnumRestApi.adoc[leveloffset=+1]
