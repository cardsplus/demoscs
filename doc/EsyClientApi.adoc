...
Mit dem API werden Patienten (engl. pet) einer Tierklinik und ihre Besitzer (engl. owner) verwaltet.
...
include::{projectDir}/app/backend/src/main/java/esy/app/client/OwnerRestApi.adoc[leveloffset=+1]

include::{projectDir}/app/backend/src/main/java/esy/app/client/PetRestApi.adoc[leveloffset=+1]
